...
{		
	public void paintComponent(Graphics g)
	{
		...
		g.drawString( "C A L E N D Á R I O   2 0 0 4", 80, 50 );
		
		g.setFont(new Font("Commercial Script", Font.BOLD, 16));
		g.drawString("Janeiro                                  Fevereiro                             Março                                Abril",50,80);
		...
		g.drawString("1-Ano Novo                                     4-Dia do Início da luta armada      8-Dia Internacional da Mulher     4-Paz e reconciliação Nacional",35,220);
		g.drawString("4-Heróis da Baixa de Cassanje  24- Carnaval                                                                                                    9-Sexta-Feira Santa",35,230);
		g.drawString("11- Páscoa", 580, 240);
	}
}
