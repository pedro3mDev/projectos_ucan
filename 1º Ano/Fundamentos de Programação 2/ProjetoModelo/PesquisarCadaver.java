...
Nome: Osvaldo Ramos
Numero: 2817
Ficheiro: PesquisarCadaver.java
Data: 03.06.2024
--------------------------------------*/
...
public class PesquisarCadaver extends JFrame
{	
	PainelCentro centro;
	PainelSul sul;
	
	public PesquisarCadaver()
	{
		super("Pesquisas");
		...
		public void actionPerformed(ActionEvent evt)
		{
			if (evt.getSource() == pesquisarJB)
				if (centro.getTipoPesquisa() == 1)
					CadaverFile.pesquisarCadaverPorNome( centro.getNomeProcurado() );
				else
